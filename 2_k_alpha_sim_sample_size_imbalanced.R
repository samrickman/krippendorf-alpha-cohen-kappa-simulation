...
# with error rate 0.2 and balanced data - i.e. confusion matrix
#      0    1
# 0 0.72 0.18
# 1 0.02 0.08
...
ggsave("./plots/kripp_alpha_comparison/boot_kap_lineplot_imbalanced.png", w = 12, h = 7.5)
...
ggsave("./plots/kripp_alpha_comparison/boot_kap_ci_scatter_imbalanced.png", w = 12, h = 7.5)

# Save data so I don't keep having to run simulations
write.csv(alpha_long, "./simulated_data/2_alpha_imbalanced.csv", row.names = FALSE)