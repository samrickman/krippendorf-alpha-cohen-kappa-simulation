...
ggsave("./plots/kappa_alpha_comparison/line_plot_num_samples_balanced.png", w = 12, h = 7.5)
...
ggsave("./plots/kappa_alpha_comparison/scatter_num_samples_balanced.png", w = 12, h = 7.5)

write.csv(kappa_alpha_long, "./simulated_data/4_kappa_alpha_balanced.csv", row.names = FALSE)