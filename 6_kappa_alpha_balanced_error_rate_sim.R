...
ggsave("./plots/kappa_alpha_comparison/line_plot_error_rate_balanced.png", w = 12, h = 7.5)
...
ggsave("./plots/kappa_alpha_comparison/scatter_error_rate_balanced.png", w = 12, h = 7.5)

write.csv(kappa_alpha_long, "./simulated_data/6_kappa_alpha_imbalanced_error_rate.csv", row.names = FALSE)